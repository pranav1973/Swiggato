...
function Index1() {
  ...
  useEffect(() => {
    const handleBackNavigation = (e) => {
      e.preventDefault();
      navigate('/project/index1'); // Replace this with the desired page you want to navigate to when the user tries to leave the index page
    };
...
const [priceInput, setPriceInput] = React.useState(0);
  ...
  React.useEffect(() => {
    function validateForm() { //Function to disable Pay button untill valid food and price has been inputed
    ...
    <>
      <div className='check'>
        ...
        <header>
          ...
          <a href="/signup" role="button" onClick={handleLogout}>
        LogOut
      </a>
          </nav>
        </header>
